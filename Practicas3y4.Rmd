...
pivot_longer(data =raw,cols =wk1:wk76, names_to = 'Semana' , values_to = 'Valores',names_prefix ='wk' )

pivot_wider(data,names_from = element, values_from =d1:d31 )

pivot_longer(raw,cols =element:d31 ,names_to = ,values_to = )
```
